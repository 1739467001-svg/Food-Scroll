    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-8 md:py-12 bg-gradient-to-b from-china-beige to-white">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6 md:mb-8">
          ...
          <p className="text-sm md:text-base text-china-ink-light">管理员登录</p>
        </div>
        ...
        <div className="china-card p-5 md:p-8 relative">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-center text-china-ink mb-4 md:mb-6">欢迎回来</h2>
          ...
          <div className="mt-5 md:mt-6 text-center">
            <span className="text-china-ink-light text-sm">还没有账号？</span>
            <Link to="/register" className="ml-2 text-china-red hover:underline font-medium text-sm">
              立即注册
            </Link>
          </div>
        </div>
